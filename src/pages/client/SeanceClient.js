...
export default function SeanceClient() {
                    ...
                    return (
                      <div key={sem} style={{ borderBottom: si < semsPrev.length - 1 ? '1px solid #f3f4f6' : 'none' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.45rem 0.75rem', background: sem === semaineActuelle - 1 ? '#fffef5' : 'white' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            <span style={{ background: sem === semaineActuelle - 1 ? '#333333' : '#f3f4f6', color: sem === semaineActuelle - 1 ? 'var(--accent)' : '#6b7280', borderRadius: 6, padding: '0.1rem 0.45rem', fontSize: '0.68rem', fontWeight: '900' }}>S{sem}</span>
  ...
  const main = (
    <div style={S.page}>
      ...
      {/* Toast */}
      <div style={{ position: 'fixed', bottom: '1.5rem', left: '50%', transform: 'translateX(-50%)', background: 'var(--accent)', color: 'var(--accent-text)', padding: '0.6rem 1.4rem', borderRadius: '999px', fontWeight: '700', fontSize: '0.875rem', opacity: saved ? 1 : 0, transition: 'opacity 0.3s', pointerEvents: 'none', zIndex: 100 }}>
        ✓ Enregistré
      </div>
          ...
          <div style={{ background: 'white', borderRadius: 14, padding: '1rem 1.1rem', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '0.5rem' }}>
              <button onClick={saveCommentaire}
                style={{ background: commentSaved ? '#16a34a' : 'var(--accent)', color: 'var(--accent-text)', border: 'none', borderRadius: 8, padding: '0.4rem 1rem', fontSize: '0.8rem', fontWeight: '700', cursor: 'pointer', transition: 'background 0.3s' }}>
...
const S = {
  ...
  curBadge:    { background: 'var(--accent)', color: 'var(--accent-text)', padding: '0.2rem 0.65rem', borderRadius: '999px', fontSize: '0.75rem', fontWeight: '700' },
  // Progress bar
  ...
  progressFill: { height: '100%', background: 'var(--accent)', borderRadius: 999, transition: 'width 0.5s ease' },
  // Cards
  ...
  exCode:      { background: 'var(--accent)', color: 'var(--accent-text)', padding: '0.15rem 0.5rem', borderRadius: '6px', fontSize: '0.72rem', fontWeight: '800' },
  ...
  serieNum:    { fontSize: '0.72rem', fontWeight: '900', color: 'var(--accent-text)', background: 'var(--accent)', width: 20, height: 20, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  serieValBtn: { marginLeft: 'auto', background: 'var(--accent)', color: 'var(--accent-text)', border: 'none', borderRadius: 6, padding: '0.3rem 0.65rem', fontSize: '0.72rem', fontWeight: '700', cursor: 'pointer', whiteSpace: 'nowrap', flexShrink: 0 },
  ...
  recupBtn:    { width: '100%', marginTop: '0.5rem', background: 'var(--accent)', color: 'var(--accent-text)', border: 'none', borderRadius: 8, padding: '0.55rem', fontSize: '0.8rem', fontWeight: '700', cursor: 'pointer' },
  // RPE toggle

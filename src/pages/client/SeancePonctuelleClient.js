    ...
    <div style={S.page}>
      ...
      <div style={S.header}>
        ...
        <div style={{ width: 32, display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
          {saved && <span style={{ fontSize: '0.65rem', color: '#e4f816', fontWeight: 700 }}>✓</span>}
        </div>
      </div>
...
const S = {
  ...
  exNum:   { width: 24, height: 24, borderRadius: 6, background: '#333', color: '#e4f816', fontSize: '0.72rem', fontWeight: 900, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  submitBtn: { flex: 1, background: '#333333', color: '#e4f816', border: 'none', borderRadius: 9, padding: '0.65rem', fontWeight: 800, fontSize: '0.88rem', cursor: 'pointer' },

    ...
    <div style={{ marginBottom: '0.875rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
        ...
        <div style={{ display: 'flex', gap: 5 }}>
          {meal.recette && (
            <button onClick={() => setShowRecette(v => !v)} style={S.smallBtn} title="Recette">
              <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>
              </svg>
            </button>
          )}
          <button onClick={() => onEditMeal(meal)} style={S.smallBtn} title="Modifier repas">
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div style={S.overlay} onClick={onClose}>
      <div style={S.sheet} onClick={e => e.stopPropagation()}>
        ...
        <p style={{ fontWeight: 800, fontSize: '1rem', margin: '0 0 1rem', color: '#1a1a1a' }}>
          {isNew ? '+ Ajouter un aliment' : 'Modifier l\'aliment'}
        </p>
...
function MealEditModal({ meal, onSave, onClose }) {
  ...
  return (
    <div style={S.overlay} onClick={onClose}>
      <div style={S.sheet} onClick={e => e.stopPropagation()}>
        <div style={{ width: 36, height: 4, background: '#e5e7eb', borderRadius: 999, margin: '0 auto 1rem' }} />
        <p style={{ fontWeight: 800, fontSize: '1rem', margin: '0 0 1rem', color: '#1a1a1a' }}>Modifier le repas</p>

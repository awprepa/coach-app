...
const styles = {
  ...
  progTitle: { fontSize: '1.5rem', fontWeight: '800', color: '#111827', margin: 0 },
  ...
  seanceNom: { fontWeight: '600', fontSize: '0.9rem', color: '#111827' },
  ...
  input: { padding: '0.7rem 0.875rem', border: '1.5px solid #e5e7eb', borderRadius: '10px', fontSize: '0.9rem', color: '#111827', outline: 'none', boxSizing: 'border-box', width: '100%' },
  select: { width: '100%', padding: '0.7rem 0.875rem', border: '1.5px solid #e5e7eb', borderRadius: '10px', fontSize: '0.9rem', color: '#111827', outline: 'none', background: 'white' },

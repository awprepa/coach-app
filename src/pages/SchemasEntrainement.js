...
const S = {
  ...
  filterBtnAdd: { padding: '5px 12px', borderRadius: 999, border: '1.5px dashed #c7d2fe', background: '#fff', color: '#4338ca', fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer' },
  ...
  newDossierInput: { padding: '5px 10px', borderRadius: 999, border: '1.5px solid #c7d2fe', fontSize: '0.75rem', outline: 'none', width: 130 },
  newDossierValider: { padding: '5px 10px', borderRadius: 999, border: 'none', background: '#4338ca', color: '#fff', fontSize: '0.72rem', fontWeight: 700, cursor: 'pointer' },
  ...
  dossierSelect: { fontSize: '0.68rem', fontWeight: 700, color: '#4338ca', background: '#eef2ff', border: 'none', borderRadius: 6, padding: '2px 4px', maxWidth: 130 },

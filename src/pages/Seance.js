        ...
        {phase === 'preview' && generatedSession && (
          <>
            <div style={AI.preview}>
              ...
              {generatedSession.note_ia && (
                <div style={AI.noteIA}>🤖 {generatedSession.note_ia}</div>
              )}
...
const AI = {
  ...
  optionBtn:    { background: 'rgba(255,255,255,0.06)', border: '1.5px solid rgba(255,255,255,0.15)', borderRadius: 20, padding: '0.45rem 0.9rem', color: 'white', fontSize: '0.82rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', transition: 'all 0.15s' },

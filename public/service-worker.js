...
const CACHE_SHELL   = 'aw-shell-v26'
const CACHE_API     = 'aw-api-v26'
const CACHE_PAGES   = 'aw-pages-v26'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v26', 'aw-api-v26', 'aw-pages-v26']
  event.waitUntil(
    caches.keys()

...
const CACHE_SHELL   = 'aw-shell-v20'
const CACHE_API     = 'aw-api-v20'
const CACHE_PAGES   = 'aw-pages-v20'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v20', 'aw-api-v20', 'aw-pages-v20']
  event.waitUntil(
    caches.keys()

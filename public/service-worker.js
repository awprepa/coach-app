...
const CACHE_SHELL   = 'aw-shell-v29'
const CACHE_API     = 'aw-api-v29'
const CACHE_PAGES   = 'aw-pages-v29'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v29', 'aw-api-v29', 'aw-pages-v29']
  event.waitUntil(
    caches.keys()

...
const CACHE_SHELL   = 'aw-shell-v132'
const CACHE_API     = 'aw-api-v132'
const CACHE_PAGES   = 'aw-pages-v132'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v132', 'aw-api-v132', 'aw-pages-v132']
  event.waitUntil(
    caches.keys()

...
const CACHE_SHELL   = 'aw-shell-v17'
const CACHE_API     = 'aw-api-v17'
const CACHE_PAGES   = 'aw-pages-v17'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v17', 'aw-api-v17', 'aw-pages-v17']
  event.waitUntil(
    caches.keys()

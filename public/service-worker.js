...
const CACHE_SHELL   = 'aw-shell-v16'
const CACHE_API     = 'aw-api-v16'
const CACHE_PAGES   = 'aw-pages-v16'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v16', 'aw-api-v16', 'aw-pages-v16']
  event.waitUntil(
    caches.keys()

...
const CACHE_SHELL   = 'aw-shell-v33'
const CACHE_API     = 'aw-api-v33'
const CACHE_PAGES   = 'aw-pages-v33'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v33', 'aw-api-v33', 'aw-pages-v33']
  event.waitUntil(
    caches.keys()

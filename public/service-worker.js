...
const CACHE_SHELL   = 'aw-shell-v23'
const CACHE_API     = 'aw-api-v23'
const CACHE_PAGES   = 'aw-pages-v23'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v23', 'aw-api-v23', 'aw-pages-v23']
  event.waitUntil(
    caches.keys()

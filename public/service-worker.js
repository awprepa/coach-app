...
const CACHE_SHELL   = 'aw-shell-v24'
const CACHE_API     = 'aw-api-v24'
const CACHE_PAGES   = 'aw-pages-v24'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v24', 'aw-api-v24', 'aw-pages-v24']
  event.waitUntil(
    caches.keys()

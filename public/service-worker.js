...
const CACHE_SHELL   = 'aw-shell-v31'
const CACHE_API     = 'aw-api-v31'
const CACHE_PAGES   = 'aw-pages-v31'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v31', 'aw-api-v31', 'aw-pages-v31']
  event.waitUntil(
    caches.keys()

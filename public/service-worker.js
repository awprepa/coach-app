...
const CACHE_SHELL   = 'aw-shell-v32'
const CACHE_API     = 'aw-api-v32'
const CACHE_PAGES   = 'aw-pages-v32'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v32', 'aw-api-v32', 'aw-pages-v32']
  event.waitUntil(
    caches.keys()

...
const CACHE_SHELL   = 'aw-shell-v25'
const CACHE_API     = 'aw-api-v25'
const CACHE_PAGES   = 'aw-pages-v25'
...
self.addEventListener('activate', event => {
  const KEEP = ['aw-shell-v25', 'aw-api-v25', 'aw-pages-v25']
  event.waitUntil(
    caches.keys()
